  ...
  return (
    <div className="bg-gray-50 h-full row-start-1 row-end-8 col-start-1 col-end-7 overflow-y-scroll pr-6 pt-4 pl-6">
      ...
      <div className="flex flex-col items-start gap-[8px]">
        ...
        <div className="text-gray-600 font-mullish text-sm non-italic font-normal leading-5 tracking-wide">
      ...
      <div className="border-b pb-6 border-primary-200 border-solid">
        <div className="flex pt-6 gap-[24px]">
          <div className="relative w-[80%]">
            <label className="absolute top-[-13px] bg-white h-[20px] font-medium tracking-wider z-[1] p-2 left-[23px] z-1 after:content-[''] after:bg-white after:absolute after:left-0 after:bottom-0 after:h-[0.8125rem text-gray-600 after:z-[-1] font-mullish text-1xl">
              Invoice Number
            </label>
            <input
        ...
        <div className="relative w-[100%] pt-6">
          <label className="absolute top-[10px] bg-white h-[20px] font-medium tracking-wider z-[1] p-2 left-[23px] z-1 after:content-[''] after:bg-white after:absolute after:left-0 after:bottom-0 after:h-[0.8125rem text-gray-600 after:z-[-1] font-mullish text-1xl">
            Currency
          </label>
          <select
            className="inline-block w-[100%] bg-white h-12 outline-none border-4 border-solid border-gray-200 shadow-none p-[2px] z-[-1] text-mullish text-sm text-gray-500 leading-5 non-italic tracking-widest"
        ...
        <div className="flex items-start flex-col gap-[8px]">
          ...
          <div className="flex items-start justify-center gap-[24px]">
            <div className="flex items-center gap-[8px]">
              ...
              <label htmlFor="vat" className="text-gray-600 font-mullish text-sm non-italic leading-5 tracking-widest font-normal">
                Value Added Tax(VAT)
              </label>
            </div>
            <div className="flex items-center gap-[8px]">
              <input type="checkbox" id="wth" name="wth" value="wth" />
              <label htmlFor="wth" className="text-gray-600 font-mullish text-sm non-italic leading-5 tracking-widest font-normal">
                Withholding Tax (WTH)
              </label>
            </div>
          </div>
      ...
      <div className="mt-6 inline-flex flex-col w-[100%] items-start gap-[24px]">
        ...
        <div className="flex flex-col items-start gap-[8px] w-[100%]">
          <div className="text-gray-600 font-mullish text-sm non-italic font-medium leading-5 tracking-widest">Attach a supporting Document</div>
          <div className="flex flex-col items-center gap-[16px] w-[100%] rounded-lg border border-solid border-gray-300">
            <Upload onChange={handleChange} className=" flex h-[32px] w-[32px] justify-center items-center" />
