  ...
  return (
    <div className="bg-gray-50 h-full row-start-1 row-end-8 col-start-1 col-end-7 overflow-y-scroll pr-6 pt-4 pl-6">
      ...
      <div className="mt-6 inline-flex flex-col w-[100%] items-start gap-[24px]">
        ...
        <div className="w-[100%]">
        <input
          className="inline-block h-[117px] w-[100%] outline-none border-4 border-solid border-gray-200 shadow-none w-[100%] p-[2px] z-[-1] text-mullish text-sm text-gray-500 leading-5 non-italic tracking-widest"
          placeholder="Invoice Title"
        />
        </div>
        <div>
