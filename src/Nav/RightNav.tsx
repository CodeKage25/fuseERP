...
function RightNav() {
    return (
        <div className="bg-white col-start-7 col-end-9 row-start-2 row-end-8 inline-flex flex-col pt-[24px] pl-[24px] pr-[47px] pb-[24px] gap-[16px] border-t border-l border-gray">
